...
public class SentencePair implements Serializable {
  ...
  public Map<String, Alignment> keyedAligns;
  ...
  public Alignment getKeyedAlignment(String alignmentKey) {
	...
	{
		this(sentencePair.ID, sentencePair.sourceFile, sentencePair.englishWords, sentencePair.foreignWords);
		setEnglishTree(sentencePair.getEnglishTree());
		setForeignTree(sentencePair.getEnglishTree());
		setAlignment(sentencePair.getAlignment());
	}
    ...
    public static Set<String> getWordSet(Iterable<SentencePair> sentencePairs,
            boolean isForeign) {
	...
	public void setForeignWords(List<String> foreignWords)
	{
